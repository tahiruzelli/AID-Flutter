...
class _RegisterPageScreenState extends State<RegisterPage> {
  ...
  Widget _buildSignInBtn() {
    return GestureDetector(
      onTap: () => registerController.onSignInButtonPressed(),
      child: RichText(
        text: const TextSpan(
          children: [
            TextSpan(
